...
public Response speed(
    ...
    try {
        ...
        rob.addErrorMessage("Could not calculate distance for speed because of error: " + ex.getLocalizedMessage());
        return rob.toResponse();
    }
    ...
    double duration = Duration.between(startDT, endDT).toSeconds() / 3600.0;

    rob.add("avgSpeedKMH", (totalDistance / duration));
